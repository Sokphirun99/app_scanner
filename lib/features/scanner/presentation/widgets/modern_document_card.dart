...
class ModernDocumentCard extends StatelessWidget {
  ...
  String _getDisplayName() {
    String name = document.title ?? document.fileName;
    if (name.length > 20) {
  ...
  String _getFileInfo() {
    final extension = document.isPdf ? 'PDF' : 'JPG';
    final date = DateTime.now().difference(document.createdAt);
    String timeAgo;
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: Text(
            'Are you sure you want to delete "${document.title ?? document.fileName}"? This action cannot be undone.',
